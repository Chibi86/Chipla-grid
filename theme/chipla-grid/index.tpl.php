...
<body>
  <div id="wrapper">
    <div id="header">
<?php if($this->views->hasContent('usermenu')) : ?>
      <div id="usermenu">
  <?php $this->views->render('usermenu');?>
      </div>
<?php endif; ?>
...
<?php endif; ?>
  ...
  <div id='page-title'>
<?php if($this->views->hasContent('page-title')) : ?>
      <h1><?php $this->views->render('page-title'); ?></h1>
<?php endif; ?>
  </div>

<?php if($this->views->hasContent('breadcrumbs')) : ?>
  <?php $this->views->render('breadcrumbs'); ?>
<?php endif; ?>

<?php if($this->views->hasContent('flashmessage')) : ?>
    <div id="flash">
      <?php $this->views->render('flashmessage'); ?>
    </div>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div id="wrap-main">
      <div id="main"<?=$this->theme->getClassesForElement('main');?>>
...
<?php if(isset($javascript_include)): ?>
